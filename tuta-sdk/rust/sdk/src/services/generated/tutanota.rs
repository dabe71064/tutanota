...
crate::service_impl!(declare, DriveFileMetadataService, "tutanota/drivefilemetadataservice", 98);
crate::service_impl!(POST, DriveFileMetadataService, DriveFileMetadataCreateData, DriveFileMetadataCreateReturn);


pub struct DriveService;

crate::service_impl!(declare, DriveService, "tutanota/driveservice", 98);
